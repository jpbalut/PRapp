...
import { PlateCalculateMenKg } from './PlateCalculateMenKg'


export const CalculateTableKg = ({varMaximo=0, barraWeight}) => {
  ...
  return (
    <>
      <h1 className=''>Peso: {varMaximo} Kilos</h1>
      <h1>Barra: {barraWeight} Kilos</h1>
                  ...
                  <tbody key={procentaje}>
                    ...
                    <th>
                      <ul>
                        ...
                        <li className="list-group-item list-group-item-primary">Peso: {(varMaximo*procentaje).toFixed(2)} Kilos</li>
                      </ul>
                    </th>
                    </tr>
                  
                  
                    <tr><td> <PlateCalculateMenKg peso = {(varMaximo*procentaje).toFixed(2)} barraWeight={barraWeight}/> </td></tr>
